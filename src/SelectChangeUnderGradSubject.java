...
public class SelectChangeUnderGradSubject extends JFrame {

	private JPanel contentPane;
	private static SelectChangeUnderGradSubject frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new SelectChangeUnderGradSubject();
	 ...
	 * Create the frame.
	 */
	public SelectChangeUnderGradSubject() {
		...
		lblCompulsorySubjects.setBounds(285, 11, 181, 14);
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (SharedData.tempStdSubNew!=null) 
				{
					...
					JPanel_SelectStdSub.table.setModel(DbUtils.resultSetToTableModel(SelectStdSub.retriveUndergradSelectSub()));
					frame.dispose();
				}
				...
				else if (SharedData.tempStdSubChange!=null) 
				{
					...
					JPanel_SelectStdSub.table.setModel(DbUtils.resultSetToTableModel(SelectStdSub.retriveUndergradChangeSub()));
					frame.dispose();
				}
				}
				else
		...
		lblSemesterCompulsory.setBounds(469, 11, 204, 14);
